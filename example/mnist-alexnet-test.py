...
with tf.Session() as sess:
	saver = tf.train.import_meta_graph('Model_save/mnist-alexnet-model4.ckpt-23201.meta')# 加载图结构
	saver.restore(sess,tf.train.latest_checkpoint('Model_save/'))#加载变量
	#saver.restore(sess,'mnist-alexnet-model2.ckpt.data-00000-of-00001')#加载变量
